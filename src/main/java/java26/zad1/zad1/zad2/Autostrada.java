...
public class Autostrada {
    ...
    public InformacjeOPojezdzie znajdzPojazd(String numerRejestracyjny) throws NieMoznaZnalezcPojazduException {
    ...
    public Double wyjazdPojazdu(String numerRejestracyjny) throws NieMoznaZnalezcPojazduException {
